# Bermuda parcel 3D terrain — 26305, 40740, 19712, 26665

Interactive 3D render of Gardener's Cottage / Ken-Ely / The Hitching Post / Wreck House (parcels 26305, 40740, 19712, 26665) with a 100.0 m buffer.
...
open the site under a sub-path:
    ...
    # open http://localhost:8000/wreck-road/
