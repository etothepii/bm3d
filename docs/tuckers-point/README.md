# Bermuda parcel 3D terrain — 44378

Interactive 3D render of Tucker's Point Golf Course (parcel 44378) with a 100.0 m buffer.
...
open the site under a sub-path:
    ...
    # open http://localhost:8000/tuckers-point/
